...
- `Заявки` — фильтры, сортировка по столбцам таблицы, телефон и e-mail клиента,
  создание, редактирование, комментарии, архивирование.
...
- Заголовки таблицы заявок переключают сортировку: по возрастанию, по убыванию,
  исходный порядок.
