...
CRM-MiniSystem — учебно-практический CRM-проект для учета заявок образовательного центра NexusCode. Система помогает менеджерам вести лиды, хранить телефон и e-mail клиента, фиксировать комментарии, контролировать следующие контакты и просрочки, а администратору — управлять пользователями, справочниками, импортом, экспортом и аналитикой.
