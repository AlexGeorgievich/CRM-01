...
CRM-MiniSystem — учебно-практический CRM-проект для учета заявок образовательного центра. Система помогает менеджерам вести лиды, фиксировать комментарии, контролировать следующие контакты и просрочки, а администратору — управлять пользователями, справочниками, импортом, экспортом и аналитикой.
...
- Справочники статусов, курсов и источников.
